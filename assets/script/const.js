...
export const mainCostumersTbody = document.querySelector(
  ".main-costumers-tbody"
);
...
export const listDomPagination = document.querySelector(
  ".main-costumers-pagination-list"
);
export const firstLinkPagination = 1;
export const stepLinkPagination = 3;

export const containerDomPagination = document.querySelector(
  ".main-costumers-pagination-container"
);
